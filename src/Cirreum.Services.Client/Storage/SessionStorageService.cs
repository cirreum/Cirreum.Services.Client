...
sealed class SessionStorageService : ISessionStorageService, IDisposable {

	private static readonly string InteropUrl = "./_content/Cirreum.Services.Client/sessionStorageProvider.js";
